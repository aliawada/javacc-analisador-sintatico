...
public class AnalisadorSintatico implements AnalisadorSintaticoConstants {
  ...
  {
    AnalisadorSintatico parser = new AnalisadorSintatico(System.in);
    while (true)
    {
      ...
      try
      {
        switch (AnalisadorSintatico.one_line())
        {
          case 0 :
      ...
      catch (Exception e)
      {
        ...
        AnalisadorSintatico.ReInit(System.in);
      }
      catch (Error e)
      {
  ...
  static public AnalisadorSintaticoTokenManager token_source;
